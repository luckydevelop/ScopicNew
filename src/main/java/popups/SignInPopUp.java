...
public class SignInPopUp {
    ...
    private final String FORGOT_PASWORD_LINK_ID = "forgotDialogButton";
    ...
    public String getPasswordFieldError(){        Helper.waitMillis(500);
        String text;
    ...
    public SignInPopUp allElementsLoaded()
    {
        ...
        listLocators.add(By.id(FORGOT_PASWORD_LINK_ID));
